...
const UserBlogCard = ({ title, blog, onEdit, onDelete }) => {
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-2xl mt-14  mx-auto mb-4 p-4 sm:p-6 hover:bg-pink-200 transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl min-h-72">
